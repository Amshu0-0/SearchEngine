...
class TestSearch(TestCase):
    ...
    def test_search(self):
        expected_musicians_search_results = ['List of Canadian musicians', 'List of soul musicians', 'List of overtone musicians', 'List of gospel musicians']
        self.assertEqual(search('musicians'), expected_musicians_search_results)
